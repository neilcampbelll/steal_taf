# Taking assessments from stockassessment.org and running a TAF version

This script creates a TAF (Transparent Assessment Framework) version of the Northeast Arctic
...
- In this example, `coast_survey_cv.dat` is fetched from stockassessment.org for provenance
